...
public class CrawlTaskJob implements Job {
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            String ingestionResult = articleIngestionService.ingestByPublishedVersion(task.getRuleVersionId(), task.getUrlTemplate());
            ...
            taskSnapshotService.writeSnapshot(runLog, "extract-result", "{\"message\":\"" + escapeJson(ingestionResult) + "\"}", "json");
